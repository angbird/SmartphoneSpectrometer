...
X_gadf = X_gadf[:, np.newaxis, :, :]  # 添加通道维度

X_train, X_temp, y_train, y_temp = train_test_split(X_gadf, y, test_size=0.3)  # 70%训练，30%临时
...
# df_data.to_csv('training_metrics_2dcnn_gadf_an.csv', index=False)
...
# torch.save(model.state_dict(), 'model_2dcnn_gadf_an.pth')  # 保存模型的权重和参数